    ...
    def move(self, row, column, checking=False, choice=None):
        ...
        if (checking == False):
            ...
            self.board.moves_made.append(
                [self.board.current_turn, self, origin_row, origin_column, row, column])
...
class Pawn(Piece):
    def move(self, row, column, checking=False, choice=None):
        ...
        if (self.column != column and self.board.grid[row][column] == None):
            ...
            if (self.board.grid[self.row][column] in self.board.pieces):
                self.board.pieces.remove(self.board.grid[self.row][column])
